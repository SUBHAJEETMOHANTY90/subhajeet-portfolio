        ...
        <div className="container-page grid gap-8 lg:grid-cols-[1fr_1.2fr]">
          <Reveal>
            <div className="space-y-4">
              ...
              <a href={profile.github} target="_blank" rel="noreferrer" className="card flex items-center gap-3"><Github className="h-5 w-5 text-accent" /> <span className="text-sm">GitHub Profile</span></a>
            </div>
          </Reveal>
